...
COMPONENT_NAME = "ragnarok"
COMPONENT_ID = uuid.uuid4().hex
COMPONENT_LOG = {
    "component_name": COMPONENT_NAME,
    "component_id": COMPONENT_ID,
    "component_version": CONFIG.RAGNAROK_VERSION,
}

# Set up logging
# ToDo: Enable this after ES logging is properly set up for Ragnarok.
...
elif CONFIG.RAGNAROK_LOG_FORMAT == LogFormat.json:
...
logger = logger_console.setup(logger_name=COMPONENT_NAME, log_level=CONFIG.RAGNAROK_LOG_LEVEL, fmt=FMT)
set_component_logger(logger)

# Set up API key
set_api_key(CONFIG.RAGNAROK_API_KEY)
